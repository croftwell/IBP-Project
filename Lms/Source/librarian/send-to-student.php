						...
						<?php
							...
							if (isset($_POST["submit"])) {
								...
								if ($title == "" | $msg =="" ) {
                                    ...
                                    $sql = mysqli_query($link, "INSERT INTO message (username, rusername, title, msg, status, time) VALUES ('$_SESSION[username]', '$_POST[rusername]', '$_POST[title]', '$_POST[msg]', 'n', '$time')");
